...
```{r}
package.list <- c("png", "vegan", "ggplot2", "ggpubr", "cowplot", "ggpmisc", "scales", "fitdistrplus", "tidyr", "ade4", "viridis", "gplots", "BiodiversityR", "indicspecies", "knitr", "here", "dplyr")
...
histogram(log(subset(long_EP, long_EP$C_Source != "Avg" & long_EP$C_Source != "NumRes")$OD), 10)
```
...
Res_Slope <- ggplot(long_EP_slope, aes(Slope ~ Tau  C_Source))+
